...
?>
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> All Members [<a href="excel/export_excel_members.php">Export to Excel</a>]</h3> 
                        </div>
...
if(isset($_GET['halaman']))
{
    ...
    $query1 = "SELECT * FROM mebers ORDER BY id DESC limit $default_index, $default_batas";
