...
try {
    ...
    $mail->Body    = '
    Yth. Bapak/Ibu
    Selamat permintaan anda untuk menjadi mitra telah disetujui. Berikut data akun anda : 
    username = Username  
    Password = password

    Berikut link untuk menuju ke halaman landing page 
